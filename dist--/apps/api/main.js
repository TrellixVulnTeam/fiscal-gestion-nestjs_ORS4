...
const constancia_entity_1 = __webpack_require__("./apps/api/src/app/constancia/entities/constancia.entity.ts");
const constancias_module_1 = __webpack_require__("./apps/api/src/app/constancia/constancias/constancias.module.ts");
    ...
    (0, common_1.Module)({
        imports: [
            ...
            typeorm_2.TypeOrmModule.forRootAsync({
                name: 'constancia',
                useFactory: () => (0, tslib_1.__awaiter)(void 0, void 0, void 0, function* () {
                    return Object.assign(yield (0, typeorm_1.getConnectionOptions)('contancia'), {
                        entities: [constancia_entity_1.Constancia],
                    });
                }),
            }),
...
/***/ "./apps/api/src/app/constancia/constancias/constancias.controller.ts":
/***/ ((__unused_webpack_module, exports, __webpack_require__) => {
...
const tslib_1 = __webpack_require__("tslib");
const common_1 = __webpack_require__("@nestjs/common");
const constancias_service_1 = __webpack_require__("./apps/api/src/app/constancia/constancias/constancias.service.ts");
...
/***/ "./apps/api/src/app/constancia/constancias/constancias.module.ts":
/***/ ((__unused_webpack_module, exports, __webpack_require__) => {
...
const common_1 = __webpack_require__("@nestjs/common");
const constancias_service_1 = __webpack_require__("./apps/api/src/app/constancia/constancias/constancias.service.ts");
const constancias_controller_1 = __webpack_require__("./apps/api/src/app/constancia/constancias/constancias.controller.ts");
...
ConstanciaModule = (0, tslib_1.__decorate)([
    (0, common_1.Module)({
        imports: [typeorm_1.TypeOrmModule.forFeature([constancia_entity_1.Constancia], 'constancia')],
...
/***/ "./apps/api/src/app/constancia/constancias/constancias.service.ts":
/***/ ((__unused_webpack_module, exports, __webpack_require__) => {
...
ConstanciaService = (0, tslib_1.__decorate)([
    (0, common_1.Injectable)(),
    (0, tslib_1.__param)(0, (0, typeorm_1.InjectRepository)(constancia_entity_1.Constancia, 'constancias')),
...
/***/ "./apps/api/src/app/constancia/entities/constancia.entity.ts":
/***/ ((__unused_webpack_module, exports, __webpack_require__) => {


Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.Constancia = void 0;
const tslib_1 = __webpack_require__("tslib");
const typeorm_1 = __webpack_require__("typeorm");
let Constancia = class Constancia {
};
(0, tslib_1.__decorate)([
    (0, typeorm_1.PrimaryColumn)(),
    (0, tslib_1.__metadata)("design:type", Number)
], Constancia.prototype, "idConstancia", void 0);
(0, tslib_1.__decorate)([
    (0, typeorm_1.Column)(),
    (0, tslib_1.__metadata)("design:type", String)
], Constancia.prototype, "rfc", void 0);
(0, tslib_1.__decorate)([
    (0, typeorm_1.Column)(),
    (0, tslib_1.__metadata)("design:type", String)
], Constancia.prototype, "nombre", void 0);
(0, tslib_1.__decorate)([
    (0, typeorm_1.Column)(),
    (0, tslib_1.__metadata)("design:type", String)
], Constancia.prototype, "apellidoPaterno", void 0);
(0, tslib_1.__decorate)([
    (0, typeorm_1.Column)(),
    (0, tslib_1.__metadata)("design:type", String)
], Constancia.prototype, "apellidoMaterno", void 0);
(0, tslib_1.__decorate)([
    (0, typeorm_1.Column)(),
    (0, tslib_1.__metadata)("design:type", String)
], Constancia.prototype, "curp", void 0);
(0, tslib_1.__decorate)([
    (0, typeorm_1.Column)(),
    (0, tslib_1.__metadata)("design:type", String)
], Constancia.prototype, "codigoPostal", void 0);
Constancia = (0, tslib_1.__decorate)([
    (0, typeorm_1.Entity)()
], Constancia);
exports.Constancia = Constancia;
...
(0, tslib_1.__decorate)([
    (0, common_1.Post)('listado'),
    (0, tslib_1.__param)(0, (0, common_1.Body)('rfcs')),
    (0, tslib_1.__metadata)("design:type", Function),
    (0, tslib_1.__metadata)("design:paramtypes", [Array]),
    (0, tslib_1.__metadata)("design:returntype", void 0)
], RfcsController.prototype, "findAll", null);
(0, tslib_1.__decorate)([
    (0, common_1.Get)(':rfc'),
    (0, tslib_1.__param)(0, (0, common_1.Param)('rfc')),
    (0, tslib_1.__metadata)("design:type", Function),
